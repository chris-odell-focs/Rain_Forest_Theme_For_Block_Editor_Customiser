...
* Type "Foxdell Folio BEC Theme Rain Forest" into the Search and hit Enter.
* Locate "Foxdell Folio BEC Theme Rain Forest" plugin in the list of search results and click Install Now.
